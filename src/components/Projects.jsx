    ...
    <section
      ...
      <div data-aos="fade-up" className="grid md:grid-cols-2 relative gap-20">
        <div className="flex text-sky-50 font-semibold rounded-xl snakegame projectcard cursor-pointer">
          <a target="_blank" href="https://ozgevuralkoca.github.io/snake">
        ...
        <a target="_blank" href="https://ozgevuralkoca.github.io/rollball">
      ...
      <div data-aos="fade-up" className="grid md:grid-cols-2 relative gap-20">
        <a target="_blank" href="https://ozgevuralkoca.github.io/miniagenda">
        ...
        <a target="_blank" href="https://ozgevuralkoca.github.io/calculator">
      ...
      <div data-aos="fade-up" className="grid md:grid-cols-2 relative gap-20">
        <a target="_blank" href="https://ozgevuralkoca.github.io/movie">
